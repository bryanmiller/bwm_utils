...
if __name__ == "__main__":
	...
	# Compute offset positions based on spiral parameters
    for ii in range(n):
        x[ii] = x[ii] + r[ii,0]
        y[ii] = y[ii] + r[ii,1]
        offset = 0.0
	...
	# Determine scale factor a from maximum offset and number of positions
    anew = fermat_scale(nnew, dmax/3600., b=b, theta=theta)
    print('a({:3d}, {:7.2f}) = {:7.5f}'.format(nnew, dmax, anew))
